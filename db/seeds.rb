...
t37 = Task.create :name => "Organise advertisement on Facebook", :status => "Done", :due_date => "2019-11-17", :priority => "Low", :owner => "Shaneen"
t38 = Task.create :name => "Review all roles required for the day", :status => "Done", :due_date => "2019-11-25", :priority => "High", :owner => "Shaneen"
t39 = Task.create :name => "Organise meeting with volunteers and distribute tasks", :status => "Stuck", :due_date => "2019-11-25", :priority => "High", :owner => "Shaneen"
t40 = Task.create :name => "Arrange for fencing to perimeter", :status => "Working On It", :due_date => "2019-12-12", :priority => "High", :owner => "Shaneen"
t41 = Task.create :name => "Organise portable freezer and fridge", :status => "Done", :due_date => "2019-11-25", :priority => "High", :owner => "Shaneen"
t42 = Task.create :name => "Prepare contigency plan for rain", :status => "Done", :due_date => "2019-11-24", :priority => "Medium", :owner => "Shaneen"
t43 = Task.create :name => "Review prices proposed by various stalls", :status => "Working On It", :due_date => "2019-11-27", :priority => "High", :owner => "Shaneen"
t44 = Task.create :name => "Review menu items for each stall", :status => "Stuck", :due_date => "2019-11-30", :priority => "High", :owner => "Shaneen"
t45 = Task.create :name => "Organise radio advertisement", :status => "Done", :due_date => "2019-11-17", :priority => "Low", :owner => "Shaneen"
t46 = Task.create :name => "Plan layout including emergency exits", :status => "Done", :due_date => "2019-11-25", :priority => "High", :owner => "Shaneen"
t47 = Task.create :name => "Traffic management plan to council", :status => "Stuck", :due_date => "2019-11-25", :priority => "High", :owner => "Shaneen"
t48 = Task.create :name => "Notify local police and residence", :status => "Working On It", :due_date => "2019-12-12", :priority => "High", :owner => "Shaneen"

t49 = Task.create :name => "Arrange for sheep", :status => "Working On It", :due_date => "2019-12-12", :priority => "High", :owner => "Ben"
puts "#{ Task.count } tasks created."

Group.destroy_all
g1 = Group.create :name => "Getting There"
g2 = Group.create :name => "Vital"
g3 = Group.create :name => "Almost There"
